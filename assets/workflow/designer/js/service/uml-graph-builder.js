define(['underscore', 'jquery', 'arbor', 'jquery-xpath'], function(_, $, arbor) {

    console.log(arguments);


    var Builder = function(attributes, options) {
    ...
    _.extend(Builder.prototype, {
        ...
        initialize: function(){},
        /**
         * Подготовка данных для графа uml
         *
         * @param data
         * @returns {{steps: Array}}
         */
        build: function(data){
            ...
            var sys = arbor.ParticleSystem(100);
        ...
        var Renderer = function (canvas) {
                ...
                redraw: function () {
                    ...
                    particleSystem.eachNode( //теперь каждую вершину
                        function (node, pt) {
                          ...
                          //получаем вершину и точку где она
            ...
            ////var startNode = arborPhysics;
            //
            //var arbor = new GraphService();
            //
            //arbor.addNode('test1');
            //
            //
            //
            console.group('build');
            console.log(sys.getNode('test1').p);
            console.log(sys.getNode('test2').p);
            console.log(sys.getNode('test3').p);
            console.groupEnd();
        }
